//Write a set_union function that unions the contents of two arrays(sets) and stores the result in a third array(set).
//Test your set_union function with the following testing code.
